...
test("MarketplaceDetector - Deve detectar marketplaces suportados corretamente", (t) => {
  const cases = [
    ...
    { url: "https://www.magazineluiza.com.br/produto/123", expected: "desconhecido" }, // Não suportado ainda
    { url: "https://www.kabum.com.br/produto/456", expected: "desconhecido" }, // Não suportado ainda
